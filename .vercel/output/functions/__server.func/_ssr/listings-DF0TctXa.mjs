import { i as SERVICE_AREAS, n as LISTINGS } from "./site-data-CLL-MbQG.mjs";
import { n as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { n as PropertyCard, r as ServiceAreasStrip, t as PageShell } from "./site-layout-Bnhqz5hQ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/listings-DF0TctXa.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageShell, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [LISTINGS.length, " active homes represented by Bobbi across central New Jersey. Each one tour-ready — reach out to schedule a private showing."]
				})
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: LISTINGS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PropertyCard, {
					...p,
					badge: p.note
				}, p.address))
			})
